          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="flex-1 sm:flex-none p-3 bg-white border border-black/5 rounded-2xl text-gray-600 hover:text-emerald-600 transition-all shadow-sm flex items-center justify-center gap-2"
              >
          ...
          {isSidebarOpen && (
            <div className="fixed inset-0 z-[100] flex items-center justify-end">
              ...
              <motion.div
                ...
                className="relative w-full max-w-md h-full bg-white shadow-2xl p-10 overflow-y-auto"
              >
